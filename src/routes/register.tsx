      ...
      >
        ...
        <Card className="shadow-elegant border-border/50">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Utilize sua conta Google para se registrar no sistema
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 border-border hover:bg-accent/50 flex items-center justify-center gap-3 text-base font-medium"
