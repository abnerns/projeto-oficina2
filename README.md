...
- Cerifique-se de possuir Npm, Node e Git instalados.
- Por meio do terminal, execute:
...
- O .env esteja configurado com as variáveis de ambiente necessárias.
- O arquivo ```serviceAccount.json``` esteja localizado na pasta ```back-end/src/common/admin/``` e configurado corretamente.
